...
object Buttons : CategoryKt("buttons") {
    ...
    val button10: ButtonConfig = obj("button10", ButtonConfig("Chocolate Factory", "SMOOTH_CHOCOLATE_BAR", "ChocolateFactory", "^Chocolate Factory$"))
    ...
    val button13: ButtonConfig = obj("button13", ButtonConfig("Crafting Table", "minecraft:crafting_table", "CraftingTable", "^Craft Item$"))
...
class ButtonConfig(tooltip: String, itemName: String, command: String, title: String) : ObjectKt(), Translatable {
    ...
    override fun getTranslationKey(): String = "config.titanomachy.buttons.button"
}
