...
enum class SearchCategory(val icon: ItemStack, val source: List<ItemSource> = emptyList()) {
    ALL(Items.COMPASS, *ItemSources.entries.filterNot { it == ItemSources.RIFT }.mapNotNull { it.itemSource }.toTypedArray()),
    ...
    RIFT(
        createSkull(""),
        RiftItemSource,
    ),
    ;
